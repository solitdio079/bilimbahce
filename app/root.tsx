...
export const links: Route.LinksFunction = () => [
  ...
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Playfair:ital,opsz,wght@0,5..1200,300..900;1,5..1200,300..900&display=swap&family=Oranienbaum&display=swap&family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap",
